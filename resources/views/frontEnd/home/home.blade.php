                ...
                <div id='tabs'>
                    ...
                    <section class='tabs-content'>
                        <article id='tabs-1'>
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('frontEndAsset') }}/images/choose-us-image-01.png" alt="">
                                </div>
                                <div class="col-md-6">
                        ...
                        <article id='tabs-2'>
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('frontEndAsset') }}/images/choose-us-image-02.png" alt="">
                                </div>
                                <div class="col-md-6">
                                    <h4>Top Level</h4>
                        ...
                        <article id='tabs-3'>
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('frontEndAsset') }}/images/choose-us-image-03.png" alt="">
                                </div>
                                <div class="col-md-6">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-01.jpg" alt="Course #1">
                    <div class="down-content">
                        <h4>Digital Marketing</h4>
                        <p>You can get free images and videos for your websites by visiting Unsplash, Pixabay, and Pexels.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-01.png" alt="Author 1">
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-02.jpg" alt="Course #2">
                    <div class="down-content">
                        <h4>Business World</h4>
                        <p>Quisque cursus augue ut velit dictum, quis volutpat enim blandit. Maecenas a lectus ac ipsum porta.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-02.png" alt="Author 2">
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-03.jpg" alt="Course #3">
                    <div class="down-content">
                        <h4>Media Technology</h4>
                        <p>Pellentesque ultricies diam magna, auctor cursus lectus pretium nec. Maecenas finibus lobortis enim.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-03.png" alt="Author 3">
                        </div>
                        <div class="text-button-pay">
                            <a href="#">Pay <i class="fa fa-angle-double-right"></i></a>
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-04.jpg" alt="Course #4">
                    <div class="down-content">
                        <h4>Communications</h4>
                        <p>Download free images and videos for your websites by visiting Unsplash, Pixabay, and Pexels.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-04.png" alt="Author 4">
                        </div>
                        <div class="text-button-free">
                            <a href="#">Free <i class="fa fa-angle-double-right"></i></a>
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-05.jpg" alt="">
                    <div class="down-content">
                        <h4>Business Ethics</h4>
                        <p>Pellentesque ultricies diam magna, auctor cursus lectus pretium nec. Maecenas finibus lobortis enim.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-05.png" alt="">
                        </div>
                        <div class="text-button-pay">
                            <a href="#">Pay <i class="fa fa-angle-double-right"></i></a>
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-01.jpg" alt="">
                    <div class="down-content">
                        <h4>Photography</h4>
                        <p>Quisque cursus augue ut velit dictum, quis volutpat enim blandit. Maecenas a lectus ac ipsum porta.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-01.png" alt="">
                        </div>
                        <div class="text-button-free">
                            <a href="#">Free <i class="fa fa-angle-double-right"></i></a>
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-02.jpg" alt="">
                    <div class="down-content">
                        <h4>Web Development</h4>
                        <p>Pellentesque ultricies diam magna, auctor cursus lectus pretium nec. Maecenas finibus lobortis enim.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-02.png" alt="">
                        </div>
                        <div class="text-button-free">
                            <a href="#">Free <i class="fa fa-angle-double-right"></i></a>
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-03.jpg" alt="">
                    <div class="down-content">
                        <h4>Learn HTML CSS</h4>
                        <p>You can get free images and videos for your websites by visiting Unsplash, Pixabay, and Pexels.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-03.png" alt="">
                        </div>
                        <div class="text-button-pay">
                            <a href="#">Pay <i class="fa fa-angle-double-right"></i></a>
                        </div>
                ...
                <div class="item">
                    <img src="{{asset('frontEndAsset') }}/images/courses-04.jpg" alt="">
                    <div class="down-content">
                        <h4>Social Media</h4>
                        <p>Pellentesque ultricies diam magna, auctor cursus lectus pretium nec. Maecenas finibus lobortis enim.</p>
                        <div class="author-image">
                            <img src="{{asset('frontEndAsset') }}/images/author-04.png" alt="">
                        </div>
                        <div class="text-button-pay">
                            <a href="#">Pay <i class="fa fa-angle-double-right"></i></a>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <article class="video-item">
                    ...
                    <figure>
                        <a href="https://www.youtube.com/watch?v=r9LtOG6pNUw" class="play"><img src="{{asset('frontEndAsset') }}/images/main-thumb.png"></a>
                    </figure>
                </article>
            </div>
        </div>
